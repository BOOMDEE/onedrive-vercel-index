...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'cd@boomdeemango.onmicrosoft.com',
  ...
  protectedRoutes: ['/学习资料（需要访问权限）'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:37ty@duck.com',
